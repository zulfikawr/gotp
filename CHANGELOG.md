...
### Changed
- **Polished CLI UX**: Silenced default Cobra error and usage dumps for a cleaner terminal experience.
- **Improved Error Guidance**: Implemented consistent, colored error messages and "Tip" suggestions across all commands.
- **Consistent Theming**: Unified command and flag coloring to match the root help theme.
- **Graceful Failures**: Improved vault detection with helpful redirection to `gotp init`.
